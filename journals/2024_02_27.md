					...
					- **Main Points**
						- Sources of Endurance
							...
							- Relying on the Holy Spirit for guidance and empowerment
							  logseq.order-list-type:: number
						- #+BEGIN_PINNED
						  Ang lakas nagmumula sa tuhod. Ang kalabaw malakas dahil laging lumuluhod. Sa umaga bago mag trabaho lumuluhod. Sa gabi bago matulog, lumuluhod. 
						  #+END_PINNED
						...
						- Practical steps having endurance
							- Seek God's wisdom and guidance (Proverbs 2:6, James 1:5)
							  logseq.order-list-type:: number
							- Surround yourself with supportive people (Ecc. 4:9-10)
							  logseq.order-list-type:: number
							- logseq.order-list-type:: number
					- Application
					- Conclusion
