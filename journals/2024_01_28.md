	...
	- #### Notes:
		- [[Notes/Meeting]]
			...
			- Decisions:
				...
				- Deadline of consolidation of Names and Sizes on JAN 31, 2024
			- Action Items
				- | Action Item | Owner |
				  |:---|:---|
				  |Consolidate names|All District Heads|
				  #+BEGIN_IMPORTANT
				  **Instructions**
				  1. Download Excel Files in "Zone 3 Men's" Messenger Group Chat
				  2. For Change of Registrants and Name Corrections please add a note for said changes
				  3. For Changes in Sizes of T-shirt and Jacket, no need to add a note
				  4. Re-send finalized Consolidation Reports in "Zone 3 Men's" Messenger Group Chat
				  #+END_IMPORTANT
				- |Pre-registration of SSAD|Bro. Jimmie Gabriela|
				-
	- #### Tasks:
		-
- ### Time-blocker
