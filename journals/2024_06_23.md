	...
	- Minutes:
		...
		- 05:02 PM : ==Mutual Fund for death benefit (proposed for zonal application)==
			- Possibilities of Sources of Fund
				...
				- meeting on July 3 10:00 @ Zen Hotel
		...
		- 04:56 PM : Suggestion to all District Ministry Heads: District Men's Ministry Tour of Duty
		- Establish Regular meetings, regular fellowships in local churches
		- Encourage to bring ministry heads/leaders
		- Next meeting to host is SID
		- #+BEGIN_QUOTE
		  "If you can start a family, you can start a c2s group" #quote
		  #+END_QUOTE
	- Decisions:
-
- #+BEGIN_QUOTE
